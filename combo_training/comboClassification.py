...
bestmodel_filename = "test_epochs{0}_train{1}.h5".format(num_epochs, dose_train)
...
history, training_time = train_combo(batch_size, num_epochs, trainX, trainY, validX, validY, 
                                     save_path, 6, dose_train, bestmodel_filepath)
#%%
num_epochs = 10000
batch_size = 10
count = 1
...
bestmodel_filepath = r"C:\Users\alber\Code\Python\PKPD\pkpd_combo\combo6\bestmodel_epochs10000_train300_100_30.h5"
model_stateless.load_weights(bestmodel_filepath)
#%%
predict = model_stateless.predict(dataXY["Combo6: [0.1, 1.0, 0.1, 10.0]"]["DOSE: 1.0"][0])
#
title = "Combo6 - 0.03, 0.1, 0.3 to predict 1 GRU, 1 Dense"
plt.title(title)
X = dataXY["Combo6: [0.1, 1.0, 0.1, 10.0]"]["DOSE: 10.0"][0][0,:,2]
Y = predict[0]
plt.scatter(X, Y)
XT = dataXY["Combo6: [0.1, 1.0, 0.1, 10.0]"]["DOSE: 10.0"][0][0,:,2]
YT = dataXY["Combo6: [0.1, 1.0, 0.1, 10.0]"]["DOSE: 10.0"][1][0]
plt.scatter(XT, YT)
# =============================================================================
