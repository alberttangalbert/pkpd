...
model_stateless.load_weights(r"C:/Users/huado/Documents/Python/pkpd/pkpd_combo/QDcombo6/epochs15000_train003.h5")
 #%%
subject = 0
...
predict = model_stateless.predict(QDcombos[combo_to_key[6]][dose_key][:,:,:3])
true = QDcombos[combo_to_key[6]][dose_key][:,:,3]
# =============================================================================
# 
