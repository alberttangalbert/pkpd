...
# =============================================================================
    ...
    #print(data_dict["observed_tp"].shape)
    ...
    if size == 1:
       ...
       # print(res)
        ...
        for i in range(0, len(start)):
            #print(torch.linspace(start[i], end[i], n_points[i]))
            res = torch.cat((res, 
                torch.linspace(start[i], end[i], n_points[i])),0)
            #print(res)
        res = torch.t(res.reshape(len(start), n_points))
    return res
