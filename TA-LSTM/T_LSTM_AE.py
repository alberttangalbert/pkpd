# Two layer T-LSTM Autoencoderhttps://open.spotify.com/artist/4Uc8Dsxct0oMqx0P6i60ea
# Inci M. Baytas
...
class T_LSTM_AE(object):
    def init_weights(self, input_dim, output_dim, name=None, std=1.0):
        return tf.Variable(tf.random.truncated_normal([input_dim, output_dim], stddev=std / math.sqrt(input_dim)), name=name)
    ...
    def get_input_output(self):
        return tf.reshape(self.input,(1, 1, 42))
